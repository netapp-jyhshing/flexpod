---
sidebar: sidebar
permalink: dc-tech-spec/dc-tech-spec_netapp_components.html
...
The table below lists the NetApp software licensing options that are available for the FlexPod Datacenter architecture. NetApp software is licensed at the FAS and AFF controller level.

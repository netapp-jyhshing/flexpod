---
sidebar: sidebar
permalink: ndac4693/ehr-epic-deploy_deployment_and_configuration_overview.html
...
The figure below illustrates the 16Gb FC/40GbE topology diagram for an Epic deployment.

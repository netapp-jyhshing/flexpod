---
sidebar: sidebar
permalink: ndac4693/ehr-epic-deploy_netapp_configuration.html
keywords: configuraiton, ha, pair, configuration, storage, fc, protocol, flexpod, epic
...
link:ehr-epic-deploy_genio_tool.html[GenIO Tool]
